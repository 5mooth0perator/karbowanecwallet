...
void MainWindow::initUi() {
  setWindowTitle(QString(tr("Robinhood Wallet %1")).arg(Settings::instance().getVersion()));
#ifdef Q_OS_WIN32
  createTrayIcon();
#endif
...
void MainWindow::createTrayIcon()
{
    ...
    QString toolTip = QString(tr("Robinhood Wallet %1")).arg(Settings::instance().getVersion());
